...
import com.bourneless.screen.MenuScreen;
...
public class Instance implements Serializable {
	...
	public Instance(String size, String treeGrowth, String godname, GameScreen gameScreen) {
		if (godname == null) {
			godname = "God";
		}
		...
		toggleSoundButtonOff = new Button(Main.resourceLoader.toggleSoundOff,
				new Vector2(20, 20));
		ui = new UI();
		map = new Map(size, treeGrowth, god, gameScreen);
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (selectedItem == null) {
			...
			map.addEntity(selectedItem, (GameScreen)Main.game.getScreen(), ui);
			selectedItem = null;
